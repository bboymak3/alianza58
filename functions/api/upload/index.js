...
//   1. Acepta AMBOS campos: 'file' (admin/editar-propiedad) y 'image' (cuenta/publicar)
//   2. Devuelve el r2_key correcto para que el frontend lo pueda asociar
//   3. Genera keys con formato properties/<userId>/<timestamp>-<filename>
//   4. Marca customMetadata con uploadedBy y propertyId vacío (se setea al asociar)
...
export async function onRequestPost({ request, env }) {
  ...
  // Aceptar 'file' o 'image' (compatibilidad con ambos frontends)
  ...
  try {
    await env.MEDIA.put(r2Key, buffer, {
      ...
      customMetadata: {
        ...
        propertyId: '',  // se setea al asociar la imagen a una propiedad
  ...
  // Devolver respuesta con URL pública (a través de /api/serve) y r2_key
